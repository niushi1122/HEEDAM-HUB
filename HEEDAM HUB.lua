...
function LoadSettings()
		if readfile and writefile and isfile and isfolder then
			if not isfolder("HEEDAM Hub") then
				makefolder("HEEDAM Hub")
			end
			if not isfolder("HEEDAM Hub/Blox Fruits/") then
				makefolder("HEEDAM Hub/Blox Fruits/")
			end
			if not isfile("HEEDAM Hub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then
				writefile("HEEDAM Hub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(_G.Settings))
			else
				local Decode = game:GetService("HttpService"):JSONDecode(readfile("HEEDAM Hub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json"))
...
function SaveSettings()
		if readfile and writefile and isfile and isfolder then
			if not isfile("HEEDAM Hub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then
				...
				writefile("HEEDAM Hub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(Array))
			end
		else
			return warn("Status : Undetected Executor")
		end
...
local Win = library:Evil("HEEDAM Hub | ","",_G.Logo )
